...
if check_file_exists(character_prompt_file_path):
    ...
    with open(f'prompts/character_prompts.txt', 'r') as f:
        character_prompt = f.read()
else:
    print("character_prompts ファイルが存在しません")
    with open(f'prompts/character_prompts_Sample.txt', 'r') as f:
        character_prompt = f.read()
...
if check_file_exists(sys_prompt_file_path):
    ...
    with open(f'prompts/system_prompts.txt', 'r') as f:
        system_prompt = f.read()
else:
    print("system_prompts ファイルが存在しません")
    with open(f'prompts/system_prompts_Sample.txt', 'r') as f:
        system_prompt = f.read()
